...
insert into test1.category (category_name) values ('телевизор');
insert into test1.category (category_name) values ('холодильник');
insert into test1.category (category_name) values ('стиральная машина');
insert into test1.category (category_name) values ('пылесос');
insert into test1.category (category_name) values ('игровая консоль');
insert into test1.category (category_name) values ('микроволновая мечь');
insert into test1.category (category_name) values ('мультиварка');
insert into test1.category (category_name) values ('кофеварка');
insert into test1.category (category_name) values ('электрический чайник');
